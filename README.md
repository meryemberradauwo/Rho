...
The following is the source code with comments and directions: 

%___________________________________________First section identifies variables__________________________________
...
%The variables n, n1, n3, n4, n5, n6 can all be changed in the source code, but these numbers seem to give the best fit.
 properties (Access = public)
        %thresholds
        n=2; %2  relates to n2
        n1=-1e-4; %-1e-4 relates to amplitude of negative voltage values
        n3; %20  controls outliers, max difference between T and V values **change this if fit is off**
        ...
        %This section introduces constants that will be inputed by the user through the app interface.
        %constants
...
app.Table.Data = app.t; % Add data to the Table UI Component
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.LorenzNumberWK2EditFieldLabel.Text = 'Lorenz Number [WÎ©K^-2]';
            ...
            app.Table.ColumnName = {'T [K]'; 'Ï� [ÂµÎ©cm]'; 'err Ï�'; 'Îº [W/(mK)]'; 'err Îº'};
            app.Table.RowName = {};
            ...
            app.TextArea.Value = {'References: '; ''; 'Chu, T. K. & Chi, T. C. (1981) Properties of Selected Ferrous Alloying Elements, Vol. III-1., McGraw-Hill.'; ''; 'Gomi, H., & Yoshino, T. (2019). Resistivity, Seebeck coefficient, and thermal conductivity of platinum at high pressure and temperature. Physical Review B, 100(21), 214302. '; ''; 'Joshua A. H. Littleton, Richard A. Secco, Wenjun Yong, and Meryem Berrada (2019). "Electrical resistivity and thermal conductivity of W and Re up to 5â€‰GPa and 2300â€‰K", Journal of Applied Physics 125, 135901.'};
